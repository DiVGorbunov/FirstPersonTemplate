...
public class WeaponController : MonoBehaviour
{
    ...
    [Tooltip("The projectile alt prefab")]
    ...
    public bool isAltFireAvailable = false;
    ...
    public bool HandleShootInputs(bool inputDown, bool inputHeld, bool inputUp, bool alt = false)
    {
        switch (shootType)
        {
    ...
    bool TryReleaseCharge(bool alt = false)
    {
        if (isCharging)
        {
            HandleShoot(alt);
    ...
    void HandleShoot(bool alt = false)
    {
        ...
        for (int i = 0; i < bulletsPerShot; i++)
        {
            ...
            if (alt)
            {
                newProjectile = Instantiate(projectilePrefabAlt, weaponMuzzle.position, Quaternion.LookRotation(shotDirection));
            }
            else {
